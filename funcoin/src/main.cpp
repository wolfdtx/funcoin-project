...
uint256 hashGenesisBlock("0xab22e7b6cfbed5b1354fe4b56e175723e73c4c9367dca39288f07a9667bab104");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb898c459b6f056fda438b3e9eed7adaa9abae401a12a6d369f618e19c11c99ff");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04de623a0a817f274b0c7daeec0d913e2441c9adfab0779d0b963c82ee5008f237735b2cdfdb9da9c97a67fba3096fd40be592eb4aff53c7d851dab51dc409a827") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1524461014;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087892156;

        if (fTestNet)
        {
            block.nTime    = 1524460998;
            block.nNonce   = 389191857;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x38614fee4ade1e5768df13a9ac84292a7946b78288093cce8aebdcda8be27b94"));
        block.print();
